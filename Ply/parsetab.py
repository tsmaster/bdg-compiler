...
_lr_productions = [
  ...
  ('funcdef -> type IDENTIFIER LPAREN argdecllist RPAREN LBRACE statementlist RBRACE','funcdef',8,'p_funcdef','compiler.py',163),
  ('type -> INT','type',1,'p_type','compiler.py',174),
  ('type -> FLOAT','type',1,'p_type','compiler.py',175),
  ('type -> STRING','type',1,'p_type','compiler.py',176),
  ('type -> VOID','type',1,'p_type','compiler.py',177),
  ('type -> IDENTIFIER','type',1,'p_type','compiler.py',178),
  ('argdecllist -> empty','argdecllist',1,'p_argdecllist_empty','compiler.py',183),
  ('argdecllist -> argdecl','argdecllist',1,'p_argdecllist_one','compiler.py',187),
  ('argdecllist -> argdecl COMMA argdecllist','argdecllist',3,'p_argdecllist_many','compiler.py',191),
  ('argdecl -> type IDENTIFIER','argdecl',2,'p_argdecl','compiler.py',195),
  ('empty -> <empty>','empty',0,'p_empty','compiler.py',199),
  ('arglist -> empty','arglist',1,'p_arglist_empty','compiler.py',203),
  ('arglist -> expression','arglist',1,'p_arglist_single','compiler.py',207),
  ('arglist -> expression COMMA arglist','arglist',3,'p_arglist_many','compiler.py',211),
  ('globalvardecl -> type IDENTIFIER SEMICOLON','globalvardecl',3,'p_globalvardecl','compiler.py',215),
  ('statementlist -> empty','statementlist',1,'p_statementlist_empty','compiler.py',219),
  ('statementlist -> statement statementlist','statementlist',2,'p_statementlist_bootstrap','compiler.py',223),
  ('statement -> expression SEMICOLON','statement',2,'p_statement_expression','compiler.py',230),
  ('statement -> ifelse','statement',1,'p_statement_ifelse','compiler.py',234),
  ('statement -> RETURN expression SEMICOLON','statement',3,'p_statement_return','compiler.py',238),
  ('statement -> LOOP LBRACE statementlist RBRACE','statement',4,'p_statement_loop','compiler.py',242),
  ('statement -> BREAK SEMICOLON','statement',2,'p_statement_break','compiler.py',246),
  ('statement -> WHILE LPAREN expression RPAREN LBRACE statementlist RBRACE','statement',7,'p_statement_while_loop','compiler.py',250),
  ('statement -> IDENTIFIER ASSIGN expression SEMICOLON','statement',4,'p_statement_assign','compiler.py',254),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_parens','compiler.py',258),
  ('expression -> IDENTIFIER LPAREN arglist RPAREN','expression',4,'p_expression_functioncall','compiler.py',262),
  ('expression -> expression ISEQUAL expression','expression',3,'p_expression_binaryop','compiler.py',266),
  ('expression -> expression NOTEQUAL expression','expression',3,'p_expression_binaryop','compiler.py',267),
  ('expression -> expression LESSTHAN expression','expression',3,'p_expression_binaryop','compiler.py',268),
  ('expression -> expression GREATERTHAN expression','expression',3,'p_expression_binaryop','compiler.py',269),
  ('expression -> expression LESSEQUAL expression','expression',3,'p_expression_binaryop','compiler.py',270),
  ('expression -> expression GREATEREQUAL expression','expression',3,'p_expression_binaryop','compiler.py',271),
  ('expression -> expression LOGICAND expression','expression',3,'p_expression_binaryop','compiler.py',272),
  ('expression -> expression LOGICOR expression','expression',3,'p_expression_binaryop','compiler.py',273),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binaryop','compiler.py',274),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binaryop','compiler.py',275),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binaryop','compiler.py',276),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binaryop','compiler.py',277),
  ('expression -> IDENTIFIER','expression',1,'p_expression_variable','compiler.py',282),
  ('expression -> MINUS expression','expression',2,'p_expression_negop','compiler.py',287),
  ('expression -> NUMBER','expression',1,'p_expression_number','compiler.py',291),
  ('elifgroup -> empty','elifgroup',1,'p_elifgroup_empty','compiler.py',295),
  ('elifgroup -> ELIF LPAREN expression RPAREN LBRACE statementlist RBRACE elifgroup','elifgroup',8,'p_elifgroup_many','compiler.py',299),
  ('optelse -> empty','optelse',1,'p_optelse_empty','compiler.py',303),
  ('optelse -> ELSE LBRACE statementlist RBRACE','optelse',4,'p_optelse_single','compiler.py',307),
  ('ifelse -> IF LPAREN expression RPAREN LBRACE statementlist RBRACE elifgroup optelse','ifelse',9,'p_ifelse_if','compiler.py',311),
]
